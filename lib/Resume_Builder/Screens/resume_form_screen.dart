...
class ResumeFormScreen extends StatelessWidget {
  ...
  // Tablet/Desktop: Two-column layout with step rail on left
    ...
    return AppBar(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        ...
                        fontSize:
                            Responsive.isDesktop(context) ? 17 : 15,
      ...
      actions: [
        Obx(() => Container(
          ...
          decoration: BoxDecoration(
            color:
                controller.selectedTemplateAccent.value.withOpacity(0.12),
...
// Wraps form content to max width on wide screens
// ============================================
    ...
    return Center(
      child: ConstrainedBox(
        constraints: BoxConstraints(
          maxWidth: Responsive.isDesktop(context) ? 860 : 700,
        ),
        child: child,
      ),
    );
...
class _ValidationBanner extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hPad = Responsive.isTablet(context) || Responsive.isDesktop(context)
        ? 32.0
        : 20.0;
    return Container(
      margin: EdgeInsets.fromLTRB(hPad, 8, hPad, 8),
    ...
    return _ResponsiveWrapper(
      child: Column(
        ...
        children: [
          ...
          // Two-column layout for name and title on wide screens
          if (isWide)
            Padding(
                        ...
                        children: [
                          Expanded(
                            child: _FormField(
                              ...
                              required: false,
                              onChanged: (v) =>
                                  controller.resumeData.value.github = v,
                            ),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Obx(() {
              final count =
                  controller.resumeData.value.summary.trim().length;
              return Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const Text('Add your relevant work history',
                        style: TextStyle(
                            color: AppColors.textSecondary, fontSize: 13)),
                  ],
                ),
          ...
          Obx(() {
            ...
            if (exps.isEmpty) {
              return _EmptyState(
                ...
                subtitle:
                    'Tap "Add Experience" to add your work experience',
                accent: controller.selectedTemplateAccent.value,
                  ...
                  children: [
                    Text('Education',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.w700)),
                    const SizedBox(height: 3),
                    const Text('Your academic background',
                        style: TextStyle(
                            color: AppColors.textSecondary, fontSize: 13)),
                  ],
                ),
                    ...
                    return Column(children: [
                      Row(children: [
                        Expanded(
                          child: _InlineField(
                            label: 'Degree *',
                            hint: 'Bachelor of Science in CS',
                  ...
                  return Obx(() => Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 6),
                        GestureDetector(
                          onTap: () => controller.removeSkill(i),
  ...
  Widget build(BuildContext context) {
    return _ExtraSection(
      ...
      child: Obx(() {
        ...
        if (awards.isEmpty) {
          return const _ExtraEmptyHint(
              text: 'Add your awards and achievements');
        }
        return Column(
  ...
  Widget build(BuildContext context) {
    return _ExtraSection(
      ...
      child: Obx(() {
        ...
        if (items.isEmpty) {
          return const _ExtraEmptyHint(
              text: 'Add board memberships or affiliations');
        }
        return Column(
  ...
  Widget build(BuildContext context) {
    return _ExtraSection(
      ...
      child: Obx(() {
        ...
        if (tools.isEmpty) {
          return const _ExtraEmptyHint(
              text: 'Add tools you use professionally');
        }
        return Wrap(
          spacing: 8,
          runSpacing: 8,
          children: tools.asMap().entries.map((e) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                        ctrl.selectedTemplateAccent.value.withOpacity(0.3)),
              ),
...
class _FinalResumeScreenState extends State<FinalResumeScreen> {
  ...
  Future<void> _autoGenerateAndSave() async {
    try {
      ...
      final fileName =
          'Resume_${controller.resumeData.value.fullName.replaceAll(' ', '_')}_${DateTime.now().millisecondsSinceEpoch}.pdf';
  ...
  Future<Uint8List> _generatePDF() async {
    try {
      ...
      if (imageFile == null) throw Exception('Failed to capture screenshot');
      ...
      double scale =
          (pageWidth / imageWidth).clamp(0.0, pageHeight / imageHeight);
 ...
 Future<void> _downloadPDF() async {
  try {
    ...
    if (kIsWeb) {
      ...
      final anchor = html.AnchorElement(href: url)
        ..setAttribute('download', 'Resume_${controller.resumeData.value.fullName.replaceAll(' ', '_')}_${DateTime.now().millisecondsSinceEpoch}.pdf')
        ..click();
    ...
    if (savedPath != null) {
      Get.snackbar('✅ Downloaded!',
          Platform.isAndroid ? 'PDF saved to Downloads folder' : 'PDF saved successfully',
          backgroundColor: Colors.green,
          colorText: Colors.white,
          snackPosition: SnackPosition.BOTTOM,
          margin: const EdgeInsets.all(16),
  ...
  Future<String?> _saveWithMediaStore(Uint8List pdfBytes) async {
    try {
      final fileName =
          'Resume_${controller.resumeData.value.fullName.replaceAll(' ', '_')}_${DateTime.now().millisecondsSinceEpoch}.pdf';
      final String? savedPath = await platform.invokeMethod('saveToDownloads', {
        'fileName': fileName,
      ...
      debugPrint('Failed to save with MediaStore: $e');
      return null;
    }
  }
  ...
  Future<String?> _saveToDownloadsLegacy(Uint8List pdfBytes) async {
    try {
      ...
      debugPrint('Error saving to Downloads legacy: $e');
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isWide
          ? _buildWideResumeLayout(context)
          : _buildNarrowResumeLayout(context),
    );
  }

  // Mobile: single column preview
  Widget _buildNarrowResumeLayout(BuildContext context) {
    return Column(
      children: [
        _buildInfoBar(),
        const SizedBox(height: 12),
  ...
  // Tablet/Desktop: side-by-side or centered wide preview
  Widget _buildWideResumeLayout(BuildContext context) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => _buildActionButton(
                    ...
                    label: 'Download PDF',
                    onTap: isDownloading.value ? null : _downloadPDF,
                    accent: controller.selectedTemplateAccent.value,
  ...
  Widget _buildInfoBar({bool compact = false}) {
    return Container(
      padding: EdgeInsets.symmetric(
          horizontal: compact ? 12 : 16, vertical: compact ? 12 : 10),
      decoration: BoxDecoration(
        color: AppColors.cardBg,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: AppColors.border),
      ...
      child: compact
          ? Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                const Text('Pinch or scroll to zoom preview',
                    style: TextStyle(
          ...
          : Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Expanded(
                  child: Text('Preview your resume',
                      style: TextStyle(
                          color: AppColors.textSecondary, fontSize: 12)),
                ),
                Container(
...
class _OliviaResumeRendered extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (data.skills.isNotEmpty) ...[
              _sh('Skills'),
              ...data.skills.map((s) => _sb(s, data.skillLevels[s] ?? 0.75)),
            ],
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              if (data.summary.isNotEmpty) ...[
                ...
                Text(data.summary,
                    style: const TextStyle(
                        fontSize: 9, color: Color(0xFF555555), height: 1.65)),
              ],
              if (data.experiences.isNotEmpty) ...[
                ...
                ...data.experiences.map((e) => _wi(
                    ...
                    e.responsibilities.where((r) => r.trim().isNotEmpty).toList())),
              ],
  ...
  Widget _edu(String s, String d, String y) => Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(y, style: const TextStyle(fontSize: 7, color: Color(0xFF888888))),
      ]));
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Flexible(
              child: Text(label,
                  style:
                      const TextStyle(fontSize: 7.5, color: Color(0xFFCCCCCC)))),
          Text('${(v * 100).toInt()}%',
              style: const TextStyle(fontSize: 7.5, color: Color(0xFFCCCCCC))),
        ]),
        const SizedBox(height: 3),
        ClipRRect(
      ...
      Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Text(period,
                  style:
                      const TextStyle(fontSize: 7.5, color: Color(0xFF999999))),
            ]),
            Text(co,
                style: TextStyle(
...
class _AustinResumeRendered extends StatelessWidget {
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(data.professionalTitle,
                  style:
                      TextStyle(fontSize: 9, color: accent, letterSpacing: 1)),
              const Divider(color: Color(0xFF333333), height: 24),
              if (data.summary.isNotEmpty)
                Text(data.summary,
                    style: const TextStyle(
                        fontSize: 8.5, color: Color(0xFFAAAAAA), height: 1.65)),
              if (data.experiences.isNotEmpty) ...[
                _st('Experience'),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (data.educationList.isNotEmpty) ...[
                  _ss('Education'),
                  ...data.educationList.map((e) =>
                      _se(e.degree, e.institution, '${e.startYear}–${e.endYear}')),
                ],
                if (data.languages.isNotEmpty) ...[
                  _ss('Languages'),
                  ...data.languages.map((l) => _si('${l.name} – ${l.proficiency}')),
                ],
  ...
  Widget _exp(String role, String co, String dates, List<String> b) => Padding(
      padding: const EdgeInsets.only(bottom: 12),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(dates,
            style: const TextStyle(fontSize: 7.5, color: Color(0xFF666666))),
        Text(role,
            style: const TextStyle(
                fontSize: 9.5, fontWeight: FontWeight.w700, color: Colors.white)),
        Text(co, style: TextStyle(fontSize: 8, color: accent)),
        const SizedBox(height: 4),
        ...b.map((x) => Padding(
            padding: const EdgeInsets.only(bottom: 2),
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('▸ ', style: TextStyle(fontSize: 8, color: accent)),
              Expanded(
                  child: Text(x,
                      style: const TextStyle(
                          fontSize: 8, color: Color(0xFF888888), height: 1.5))),
            ]))),
      ]));
...
class _NovaResumeRendered extends StatelessWidget {
                ...
                ...data.educationList.map((e) => Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text('${e.startYear}–${e.endYear}',
                          style: TextStyle(fontSize: 7.5, color: accent)),
                    ]))),
              ],
              if (data.languages.isNotEmpty) ...[
                _section('LANGUAGES'),
                ...data.languages.map((l) => Text('${l.name} – ${l.proficiency}',
                    style: const TextStyle(
                        fontSize: 8.5, color: Color(0xFF555555), height: 1.7))),
              ],
            ]),
          ),
        ]),
  ...
  Widget _tag(String t) => Container(
      ...
      decoration: BoxDecoration(
          color: accent.withOpacity(0.08),
          borderRadius: BorderRadius.circular(6)),
      child: Text(t, style: const TextStyle(fontSize: 7.5, color: Color(0xFF444444))));
  Widget _novaExp(String role, String co, String dates, List<String> bullets) =>
      Padding(
...
class _EmberResumeRendered extends StatelessWidget {
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                if (data.skills.isNotEmpty) ...[
                  _sec('SKILLS'),
                  ...data.skills.map((s) => _skillRow(s, data.skillLevels[s] ?? 0.75)),
                  const SizedBox(height: 14),
                ],
                if (data.educationList.isNotEmpty) ...[
                  _sec('EDUCATION'),
                  ...data.educationList.map((e) => Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(e.institution,
                            style:
                                const TextStyle(fontSize: 7.5, color: Color(0xFF888888))),
                        Text('${e.startYear}–${e.endYear}',
                            style: TextStyle(fontSize: 7.5, color: accent)),
                      ]))),
                ],
                if (data.awards.isNotEmpty) ...[
                  ...
                  ...data.awards.map((a) => Padding(
                      ...
                      child: Text(
                          ...
                          style:
                              const TextStyle(fontSize: 8, color: Color(0xFF555555))))),
                ],
              ]),
            ),
          ]),
  ...
  Widget _tag(String t) => Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(6)),
      child: Text(t, style: const TextStyle(fontSize: 7.5, color: Colors.white)));
  ...
  Widget _exp(String role, String co, List<String> b) => Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(role,
            style: const TextStyle(
                fontSize: 9.5, fontWeight: FontWeight.w700, color: Color(0xFF222222))),
        Text(co,
            style: TextStyle(
                fontSize: 8, color: accent, fontWeight: FontWeight.w600)),
        const SizedBox(height: 4),
        ...b.map((x) => Padding(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                  child: Text(x,
                      style: const TextStyle(
                          fontSize: 8, color: Color(0xFF555555), height: 1.5))),
            ]))),
      ]));
  Widget _skillRow(String label, double v) => Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label,
            style: const TextStyle(
                fontSize: 8, color: Color(0xFF444444), fontWeight: FontWeight.w500)),
        const SizedBox(height: 3),
        ClipRRect(
...
class _SlateResumeRendered extends StatelessWidget {
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (data.skills.isNotEmpty) ...[
              _sh('Core Expertise'),
              ...data.skills.take(5).map((s) => _sb(s, data.skillLevels[s] ?? 0.8)),
            ],
            if (data.boardMemberships.isNotEmpty) ...[
              _sh('Board Memberships'),
              ...data.boardMemberships.where((b) => b.isNotEmpty).map((b) => _li(b)),
            ],
            if (data.educationList.isNotEmpty) ...[
              _sh('Education'),
              ...data.educationList.map((e) =>
                  _edu(e.degree, e.institution, '${e.startYear}–${e.endYear}')),
            ],
          ]),
        ),
        Expanded(
  ...
  Widget _sb(String label, double v) => Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label,
            style: const TextStyle(fontSize: 7.5, color: Color(0xFFBBBBBB))),
        const SizedBox(height: 3),
        ClipRRect(
            borderRadius: BorderRadius.circular(2),
            child: LinearProgressIndicator(
                ...
                valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFF93B8F5)))),
      ]));
  Widget _li(String t) => Padding(
      padding: const EdgeInsets.only(bottom: 4),
      child: Row(children: [
  ...
  Widget _edu(String d, String s, String y) => Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(d,
            style: const TextStyle(
                fontSize: 8, fontWeight: FontWeight.w700, color: Colors.white)),
        Text(s, style: const TextStyle(fontSize: 7.5, color: Color(0xFFAAAAAA))),
        Text(y, style: const TextStyle(fontSize: 7, color: Color(0xFF93B8F5))),
      ]));
  Widget _st(String t) => Padding(
              ...
              Expanded(
                  child: Text(title,
                      style: const TextStyle(
                          ...
                          color: _navyDark))),
              Text(period,
                  style: const TextStyle(fontSize: 7.5, color: Color(0xFF999999))),
            ]),
            Text(co,
                style: TextStyle(
                    fontSize: 8, color: accent, fontWeight: FontWeight.w600)),
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                if (data.skills.isNotEmpty) ...[
                  _section('SKILLS'),
                  ...data.skills.map((s) => _sb(s, data.skillLevels[s] ?? 0.8)),
                  const SizedBox(height: 14),
                ],
                if (data.educationList.isNotEmpty) ...[
                  _section('EDUCATION'),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Center(
          child: Column(children: [
            ...
            Wrap(alignment: WrapAlignment.center, spacing: 12, children: [
              if (data.phone.isNotEmpty)
                Text(data.phone,
                    style: const TextStyle(fontSize: 8.5, color: Color(0xFF555555))),
              if (data.email.isNotEmpty)
                Text(data.email,
                    style: const TextStyle(fontSize: 8.5, color: Color(0xFF555555))),
        ...
        const SizedBox(height: 14),
        Container(
            height: templateId == 'ats_executive' ? 2 : 1.5, color: accent),
        if (data.summary.isNotEmpty) ...[
          _sec('PROFESSIONAL SUMMARY'),
          Text(data.summary,
              style:
                  const TextStyle(fontSize: 9, color: Color(0xFF333333), height: 1.7)),
        ],
        if (data.experiences.isNotEmpty) ...[
        ...
        if (data.boardMemberships.isNotEmpty &&
          ...
          ...data.boardMemberships.where((b) => b.isNotEmpty).map((b) => Padding(
              padding: const EdgeInsets.only(bottom: 4),
              child: Row(children: [
                const Text('•  ',
        ...
        if (data.keyMetrics.isNotEmpty && data.keyMetrics.any((k) => k.isNotEmpty)) ...[
          _sec('KEY ACHIEVEMENTS'),
          ...data.keyMetrics.where((k) => k.isNotEmpty).map((k) => Padding(
              padding: const EdgeInsets.only(bottom: 3),
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('▸  ', style: TextStyle(fontSize: 8.5, color: accent)),
                Expanded(
                    child: Text(k,
                        style: const TextStyle(
                            fontSize: 8.5,
  ...
  Widget _job(String title, String co, String dates, List<String> bullets) =>
      Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(co,
                style: TextStyle(
                    fontSize: 8.5, color: accent, fontWeight: FontWeight.w600)),
            const SizedBox(height: 5),
            ...bullets.map((b) => Padding(
                padding: const EdgeInsets.only(bottom: 3),
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('•  ',
                      style: TextStyle(fontSize: 8.5, color: Color(0xFF222222))),
                  Expanded(
                      child: Text(b,
                          style: const TextStyle(
                              fontSize: 8.5,

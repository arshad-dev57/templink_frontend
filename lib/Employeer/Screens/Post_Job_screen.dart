// lib/Screens/JobPostScreen.dart

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:templink/Employeer/Controller/job_post_controller.dart';
...
class JobPostScreen extends StatelessWidget {
  ...
  void _syncControllersWithRx() {
    ...
    _minSalaryController.text = controller.minSalary.value;
    _maxSalaryController.text = controller.maxSalary.value;
    _salaryTypeController.text = controller.salaryType.value;
    _currencyController.text = controller.currency.value;
  }
            ...
            children: [
              Expanded(
                child: _buildSalaryField(
                  ...
                  onChanged: (value) => controller.minSalary.value = value,
                ),
              ),
              ...
              Expanded(
                child: _buildSalaryField(
                  ...
                  hintText: "Max Salary",
                  icon: Icons.attach_money,
                  onChanged: (value) => controller.maxSalary.value = value,
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: _buildSalaryField(
                  ...
                  onChanged: (value) => controller.salaryType.value = value,
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
        ...
        children: [
          ...
          Expanded(
            child: OutlinedButton(
              onPressed: controller.isPublishing.value ? null : () {
                _showPreview();
              },
  ...
  void _showValidationDialog() {
    Get.snackbar(
      'Missing Information',
      'Please fill in Job Title and About the Job fields',
